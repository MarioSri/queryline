...
export default function Home() {
  ...
  // Open the console as a populated ledger: run the loaded sample once, on
  // first mount, after the engine's seed data is ready. Only the active page
  // renders, so this costs one 50-row paint.
